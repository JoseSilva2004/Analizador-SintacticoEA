...
title_label = tk.Label(frame_contenido, text="Analice y resuelva su expresión con IA", font=("Arial", 16, "bold"), fg="white", bg="#34495e")
...
progress_label = tk.Label(frame_contenido, text="", font=("Arial", 12), fg="white", bg="#34495e")
